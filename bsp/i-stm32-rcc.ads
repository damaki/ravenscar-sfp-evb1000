...
package Interfaces.STM32.RCC is
   ...
   subtype CR_PLL2ON_Field is Interfaces.Bit_Types.Bit;
   subtype CR_PLL2RDY_Field is Interfaces.Bit_Types.Bit;
   subtype CR_PLL3ON_Field is Interfaces.Bit_Types.Bit;
   subtype CR_PLL3RDY_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CFGR_MCO_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CIR_PLL2RDYF_Field is Interfaces.Bit_Types.Bit;
   subtype CIR_PLL3RDYF_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CIR_PLL2RDYIE_Field is Interfaces.Bit_Types.Bit;
   subtype CIR_PLL3RDYIE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CIR_PLL2RDYC_Field is Interfaces.Bit_Types.Bit;
   subtype CIR_PLL3RDYC_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1RSTR_USART4RST_Field is Interfaces.Bit_Types.Bit;
   subtype APB1RSTR_USART5RST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype AHBENR_OTGFSEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype AHBRSTR_OTGFSRST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CFGR2_PREDIV_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype CFGR2_PLL2MUL_Field is Interfaces.Bit_Types.UInt4;
   subtype CFGR2_PLL3MUL_Field is Interfaces.Bit_Types.UInt4;
   subtype CFGR2_PREDIV1SRC_Field is Interfaces.Bit_Types.Bit;
   subtype CFGR2_I2S2SRC_Field is Interfaces.Bit_Types.Bit;
   subtype CFGR2_I2S3SRC_Field is Interfaces.Bit_Types.Bit;
